...
10. Verify the resource has been created by typing `make azure-webapps-list` and checking if the name you assigned to the variable "app_service_name" in the "tutorial.tfvars" file exists in the list.
...
[tutorials-tf-backend]: ../../../terraform/azure/backend/#readme
